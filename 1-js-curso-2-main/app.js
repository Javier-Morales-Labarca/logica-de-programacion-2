...
Luego, muestra una alerta con el mensaje concatenando la 
respuesta con el texto: "Estuve en {ciudad} y me acordé de ti".
*/
let ciudad = "Sao Paulo";
function botonPrompt () {
    alert("¿En que ciudad de Brasil estuviste?");
...
function suma2numeros () { 
    let numero1 = parseInt(prompt("Digita un número"));
    let numero2 = parseInt(prompt("Digita el segundo número"));
